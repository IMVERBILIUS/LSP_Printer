...
<div class="main1">
        ...
        ?>
                ...
                <form action="proses_konfirmasi.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="number" name="quantity" id="txt1" value="<?php echo $data['quantity'] ?>" class="form-produk" readonly ><br><br>
                    
                    <label>harga satuan</label>
                    <input type="text" name="price" id="txt2" value="<?php echo $_SESSION['price'] ?>" class="form-produk" onkeyup="sum();" readonly><br><br>
                    
                    <label>stok</label>
                    <input type="text" name="stok" value="<?php echo $_SESSION['stok'];?>"  class="form-produk" readonly><br><br>
